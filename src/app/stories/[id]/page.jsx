...
const StoryDetails = async ({ params }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-base-100 shadow-md rounded-lg p-6 border border-gray-200">
      {/* Top Section */}
      ...
      <div className="mt-6">
        ...
        <p className="text-gray-500 text-justify leading-relaxed">{story.story}</p>
      </div>

      {/* About */}
      <div className="mt-6">
        <h2 className="text-xl font-semibold mb-2">About Developer</h2>
        <p className="text-gray-500 text-justify leading-relaxed">{story.about}</p>
      </div>
